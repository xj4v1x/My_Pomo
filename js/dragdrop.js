...
const tasks_screen = document.getElementById("tasks_screen");
...
draggable_icons.forEach(icon => {
    ...
    icon.addEventListener('dblclick', (e) => {
        ...
        console.log(tasks_screen.style.display);
    });
...
taskIcon.addEventListener('dblclick', (e) => {
    const taskScreen = document.getElementById('tasks_drag');
    taskScreen.classList.remove('minim2ize');
});
    ...
    */
    ...
    if (minimize) {
        minimize.addEventListener("click", function () {
            ...
            tasks_screen.style.display = "none";
        });
